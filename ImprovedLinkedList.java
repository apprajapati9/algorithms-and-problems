...
public class ImprovedLinkedList<AnyType> implements Iterable<AnyType>
{
 ...
 /**
   ...
   *  Complexity: O(n^2)
   */
   public  ImprovedLinkedList<AnyType> copy1()
   {
      ImprovedLinkedList<AnyType> twin = new ImprovedLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public ImprovedLinkedList<AnyType> copy2()
   {
      ImprovedLinkedList<AnyType> twin = new ImprovedLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public ImprovedLinkedList<AnyType> reverse()
   {
      ImprovedLinkedList<AnyType> list = new ImprovedLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public ImprovedLinkedList<AnyType> copy3()
   {
      ImprovedLinkedList<AnyType> twin = new ImprovedLinkedList<AnyType>();
      Node<AnyType> tmp = head;
...
/*****   Include the main() for testing and debugging  *****/
   ...
   {
      ImprovedLinkedList<String> list = new ImprovedLinkedList <String>();
      list.addFirst("p");
      list.addFirst("a");
      list.addFirst("e");
      list.addFirst("h");
      ...
      ImprovedLinkedList<String> twin = list.copy3();
